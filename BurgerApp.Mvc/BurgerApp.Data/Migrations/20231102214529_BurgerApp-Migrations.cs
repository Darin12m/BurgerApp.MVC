...
{
    /// <inheritdoc />
    public partial class BurgerAppMigrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderedBurgers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderedBurgers_Burgers_BurgerId",
                        column: x => x.BurgerId,
                        principalTable: "Burgers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderedBurgers_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderedBurgers_BurgerId",
                table: "OrderedBurgers",
                column: "BurgerId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderedBurgers_OrderId",
                table: "OrderedBurgers",
                column: "OrderId");
        }
